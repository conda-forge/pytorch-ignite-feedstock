...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytorch-ignite-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14532&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pytorch-ignite-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pytorch-ignite` can be installed with:

```
conda install pytorch-ignite
```

It is possible to list all of the versions of `pytorch-ignite` available on your platform with:
